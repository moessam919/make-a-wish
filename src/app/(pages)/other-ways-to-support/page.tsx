...
const page = () => {
    return (
        <div>
            <div
                className="relative bg-[url('/Victoria_GA_south-korea.avif')] bg-cover bg-center bg-no-repeat h-[600px] ">
                {/* Background overlay */}
            ...
            <div className="relative bg-[#dcf0fb] w-full">
                ...
                <div>
                    <div className=" py-16 px-4 bg-[#dcf0fb]">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-10 md:mb-20 ">
                                ...
                                <div className="bg-white  shadow-lg overflow-hidden flex flex-col">
                                    ...
                                    <div className="p-6 flex flex-col flex-grow">
                                        ...
                                        <button
                                            className="w-full bg-red-400 hover:bg-red-500 text-white font-semibold py-3 px-6 rounded-full transition-colors duration-300">
                                            Start a Fundraiser
                                        </button>
                                    </div>
                                </div>
